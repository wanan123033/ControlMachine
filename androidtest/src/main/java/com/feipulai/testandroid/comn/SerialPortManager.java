package com.feipulai.testandroid.comn;

import android.os.HandlerThread;

import com.feipulai.device.serial.SerialPort;
import com.feipulai.testandroid.comn.message.LogManager;
import com.feipulai.testandroid.comn.message.SendMessage;
import com.feipulai.testandroid.utils.ByteUtil;
import com.feipulai.testandroid.utils.LogPlus;
...
/**
 * Created by Administrator on 2019/3/27 0028.
 */
public class SerialPortManager {
     ...
     * @return
     */
    private io.reactivex.Observable<Object> rxSendData(final byte[] datas) {

        return io.reactivex.Observable.create(new ObservableOnSubscribe<Object>() {
            @Override
