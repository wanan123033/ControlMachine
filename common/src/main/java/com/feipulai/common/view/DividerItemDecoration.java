...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    /**
     * 自定义分割线
     * 也可以使用{@link Canvas#drawRoundRect(RectF, float, float, Paint)}或者{@link Canvas#drawText(String, float, float,Paint)}等等
     ...
     */
    public DividerItemDecoration(Context context, @ColorInt int color, float dividerWidth, float dividerHeight) {
