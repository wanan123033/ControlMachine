...
public class ActivityLifeCycle implements Application.ActivityLifecycleCallbacks {
    ...
    private String runTimeSpName;

    public ActivityLifeCycle(String spName, String runTimeSpName) {
        this.spName = spName;
        this.runTimeSpName = runTimeSpName;
    }

    @Override
    public void onActivityCreated(Activity activity, Bundle bundle) {

        Logger.i("onActivityCreated" + getActivityName(activity));
    }

    @Override
    public void onActivityStarted(Activity activity) {
        Logger.i("onActivityStarted " + activity.getClass().getSimpleName() + " " + foregroundActivityCount);
    ...
    public void onActivityResumed(Activity activity) {
        Logger.i("onActivityResumed" + getActivityName(activity));
    ...
    public void onActivityPaused(Activity activity) {
        Logger.i("onActivityPaused" + getActivityName(activity));
    ...
    public void onActivityStopped(Activity activity) {
        Logger.i("onActivityStopped" + getActivityName(activity));
        addAppUseReduceTimeIfNeeded(activity);
        ...
        if (foregroundActivityCount == 0) {
            ...
            Logger.i("switch to background (reduce time[" + appUseReduceTime + "])");
...
//            }else {
            ...
            saveTodayPlayTime(activity, runTimeThisDay);
            lastCheckTime = System.currentTimeMillis();
            Logger.i("run time  :" + runTimeThisDay);
        }
    }

    @Override
    public void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
        Logger.i("onActivitySaveInstanceState" + getActivityName(activity));
    }
    ...
    public void onActivityDestroyed(Activity activity) {
        ...
        saveTodayPlayTime(activity, runTimeThisDay);
        lastCheckTime = System.currentTimeMillis();
        Logger.i("onActivityDestroyed" + getActivityName(activity) + "--runTimeThisDay:" + runTimeThisDay + "--lastCheckTime" + lastCheckTime);
    }
    ...
    private void saveTodayPlayTime(Context context, long time) {
        long todayTime = SharedPrefsUtil.getValue(context, spName, runTimeSpName, 0l);
        Logger.i("使用时长Log:" + (todayTime + time));
        SharedPrefsUtil.putValue(context, spName, runTimeSpName, todayTime + time);
    }
}
