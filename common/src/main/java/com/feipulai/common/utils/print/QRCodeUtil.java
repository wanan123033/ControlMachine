...
public class QRCodeUtil {
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(String content, int size, @Nullable Bitmap logoBitmap, String margin, float logoPercent) {
        return createQRCodeBitmap(content, size, "UTF-8", "H", margin, Color.BLACK, Color.WHITE, null, logoBitmap, logoPercent);
    }
