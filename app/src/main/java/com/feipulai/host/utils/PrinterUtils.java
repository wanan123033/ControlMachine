	...
	public static void printResult(Context context,Student student,RoundResult result,RoundResult weightResult){
		...
		switch(machineCode){
			case ItemDefault.CODE_HW:
				PrinterManager.getInstance().print("身  高:" + displayResult);
				PrinterManager.getInstance().print("体  重:" + ResultDisplayUtils.getStrResultForDisplay(weightResult.getResult()));
