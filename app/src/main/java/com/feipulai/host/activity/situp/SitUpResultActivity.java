...
public class SitUpResultActivity
	...
	private volatile boolean isAutoPrint;
	...
	private void init(){
		...
		mLEDResultDisplayTask = new LEDResultDisplayTask(new LEDResultDisplayer(mPairs.size(),hostId,this));
	...
	private void printResult(BaseStuPair pair,int result){
		...
		PrinterManager.getInstance().print("仰卧起坐  " + hostId + "号机\n");
