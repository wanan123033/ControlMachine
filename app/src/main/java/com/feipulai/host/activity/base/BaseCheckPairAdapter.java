	...
	protected void convert(ViewHolder holder,BaseStuPair pair){
		...
		switch(deviceState.getState()){
			...
			case BaseDeviceState.STATE_DISCONNECT:
				holder.tvDeviceId.setBackground(mContext.getResources().getDrawable(R.drawable.shape_round_textview_red));
			...
			case BaseDeviceState.STATE_LOW_BATTERY:
				holder.tvDeviceId.setBackground(mContext.getResources().getDrawable(R.drawable.shape_round_textview_yellow));
				break;
			
			case BaseDeviceState.STATE_CONFLICT:
				holder.tvDeviceId.setBackground(mContext.getResources().getDrawable(R.drawable.shape_round_textview_conflict));
				break;
			
			case BaseDeviceState.STATE_STOP_USE:
				holder.tvDeviceId.setBackground(mContext.getResources().getDrawable(R.drawable.shape_round_textview_grey));
				break;
			
			default:
				holder.tvDeviceId.setBackground(mContext.getResources().getDrawable(R.drawable.shape_round_textview));
				break;
