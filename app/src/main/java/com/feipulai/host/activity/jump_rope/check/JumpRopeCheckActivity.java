...
public class JumpRopeCheckActivity
	...
	@OnClick({R.id.btn_device_pair, R.id.btn_change_hand_group, R.id.btn_change_bad, R.id.btn_start_test,
			R.id.btn_stop_use, R.id.btn_led_setting, R.id.btn_delete_student, R.id.btn_del_all, R.id.tv_project_setting})
	public void onViewClicked(View view) {
		switch (view.getId()) {
			...
			case R.id.tv_project_setting:
				startActivity(new Intent(this, JumpRopeSettingActivity.class));
				break;
		}
	}
