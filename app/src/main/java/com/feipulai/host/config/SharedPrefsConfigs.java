...
public class SharedPrefsConfigs {
    ...
    public static final String JUMP_ROPE_CURRENT_GROUP = "JUMP_ROPE_CURRENT_GROUP";
//    public static final String IP_ADDRESS = "IP_ADDRESS";
    ...
    //立地跳远设备设置数量
    public static final String STAND_JUMP_TEST_NUMBER = "STAND_JUMP_TEST_NUMBER";
    //立地跳远设备设置数量
    public static final String STAND_JUMP_TEST_POINTS = "STAND_JUMP_TEST_POINTS";
    // 肺活量设备数量
    public static final String VITAL_CAPACITY_TEST_NUMBER = "VITAL_CAPACITY_TEST_NUMBER";
    //坐位体前屈设备设置数量
    public static final String SIT_REACH_TEST_NUMBER = "SIT_REACH_TEST_NUMBER";
    //实心球
