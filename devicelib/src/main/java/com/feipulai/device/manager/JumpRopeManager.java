...
public class JumpRopeManager{
	 ...
	 */
	public void link(int hostId,int handId,int handPower,int handGroup){
		...
		RadioManager.getInstance().sendCommand(new ConvertCommand(new RadioChannelCommand(SerialConfigs.sProChannels.get(ItemDefault.CODE_TS) + hostId - 1)));
