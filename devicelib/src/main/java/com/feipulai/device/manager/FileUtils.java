...
public class FileUtils {
    ...
    private static String diskLogFilePath = Environment.getExternalStorageDirectory() + "/logger/device/" + logFileName;
    ...
    public static void log(String log) {
        ...
        fileLinesWrite(diskLogFilePath, logTime + log, true);
    }
