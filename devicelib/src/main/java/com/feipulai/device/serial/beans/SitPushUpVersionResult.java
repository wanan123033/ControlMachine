...
public class SitPushUpVersionResult {
	...
	public SitPushUpVersionResult(byte[] data){
		...
		LogUtils.serial("仰卧起坐俯卧撑返回设备版本数据(解析前):" + StringUtility.bytesToHexString(data));
		LogUtils.serial("仰卧起坐俯卧撑返回设备版本数据(解析后):" + toString());
	}
