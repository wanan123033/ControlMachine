...
public class MiniActivity extends AppCompatActivity {
    ...
    private void initTTs() {
        ...
        if (isMix) {
            ...
            //文本模型文件路径，即bd_etts_text.dat所在的路径。
            mSpeechSynthesizer.setParam(SpeechSynthesizer.PARAM_TTS_TEXT_MODEL_FILE, TEXT_FILENAME); // 文本模型文件路径 (离线引擎使用)
	        //声学模型文件路径。即"bd_etts_speech_female.dat“所在的路径。需要男声，请使用bd_etts_speech_male.dat。
	    ...
	    mSpeechSynthesizer.setParam(SpeechSynthesizer.PARAM_VOLUME, "9"); // 设置合成时音频的音量，0-9 ，默认 5
	    ...
	    result = mSpeechSynthesizer.setStereoVolume (0.5f, 0.5f);
