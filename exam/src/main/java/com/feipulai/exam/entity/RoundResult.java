...
public class RoundResult implements Serializable {
    ...
    public static final int RESULT_STATE_BACK = -2;
    public static final int RESULT_STATE_WAIVE = -3;
     ...
     */
    @NotNull
    private int resultState;//成绩状态 0正常  1犯规    -2中退    -3（放弃 服务器状态）     体侧系统没有中退和放弃,且犯规均为机器判定的犯规
    @NotNull
