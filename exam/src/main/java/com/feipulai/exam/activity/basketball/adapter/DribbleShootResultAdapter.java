 ...
 */
public class DribbleShootResultAdapter extends BaseQuickAdapter<BasketBallTestResult, DribbleShootResultAdapter.ViewHolder> {
    ...
    public DribbleShootResultAdapter(@Nullable List<BasketBallTestResult> data) {
        super(R.layout.item_basketball_round_result, data);
    }

    @Override
    protected void convert(DribbleShootResultAdapter.ViewHolder helper, final BasketBallTestResult item) {
