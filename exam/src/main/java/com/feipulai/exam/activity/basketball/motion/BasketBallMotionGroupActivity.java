...
public class BasketBallMotionGroupActivity extends BaseTitleActivity implements BasketBallListener.BasketBallResponseListener, TimerUtil.TimerAccepListener, BaseQuickAdapter.OnItemClickListener {
    ...
    protected void initData() {
        ...
        facade = new BasketBallMotionFacade(setting.getTestType(), setting.getAutoPenaltyTime(), setting.getUseLedType(), this);
                        ...
                        switch (which) {
                            ...
                            case 1:
                                ...
                                InteractUtils.printResults(group, testCache.getAllStudents(), testCache.getResults(),
                                        TestConfigs.getMaxTestCount(BasketBallMotionGroupActivity.this), testCache.getTrackNoMap());
                                break;
                        }
                    }
                }).create().show();
        ...
        switch (testResult.getResultState()) {
            case RoundResult.RESULT_STATE_NORMAL:
                ...
                if (setting.getUseLedType() == 0) {
                    ...
                    ballManager.sendSetStopStatusTo(SettingHelper.getSystemSetting().getHostId(),
                            DateUtil.caculateTimeLong(testResult.getResult(), TestConfigs.sCurrentItem.getDigital(), TestConfigs.sCurrentItem.getCarryMode()), getAccuracy());
                }
                break;
