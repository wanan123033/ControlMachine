...
public class FootballMotionActivity extends BaseTitleActivity implements IndividualCheckFragment.OnIndividualCheckInListener,
...
//                && resultList.get(resultAdapter.getSelectPosition()).getMachineResultList().size() > 0)
    ...
    public void onViewClicked() {
        IntentUtil.gotoActivity(this, FootballMotionPairActivity.class);
    }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (student != null) {
                    ...
                    InteractUtils.toastSpeak(FootballMotionActivity.this, "该考生不存在");
                }
//                if (student == null) {
