...
public class VHTableView extends LinearLayout implements HListViewScrollView.ScrollChangedListener {
    ...
    private void initContentList(VHBaseAdapter conentAdapter) {
        ...
        contentAdapter = new ContentAdapter(conentAdapter);
    ...
    public class ContentAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, final ViewGroup parent) {
            ...
            viewHolder.ll_datagroup.setOnLongClickListener(viewHolder.rowClickListener);
            viewHolder.ll_firstcolumn.setOnLongClickListener(viewHolder.rowClickListener);
    ...
    public class RowClickListener implements OnLongClickListener, OnClickListener {
        ...
        public boolean onLongClick(View v) {
            if (null != conentAdapter && null != convertView) {
                conentAdapter.OnLongClickContentRowItem(row, convertView);
            }
            return false;
        }
    }
