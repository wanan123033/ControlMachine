...
import static com.feipulai.exam.tcp.TCPConst.MAX_RECORD_COUNT;
import static com.feipulai.exam.tcp.TCPConst.MAX_RUN_SPORTER_NUM;
...
//考试场地//////////////
    ...
    //分组ID需要和服务器一致（考试中的分组类型0-正常组，2-缓考组，1-补考组
...
//        }
    ...
    public String toString() {
        return "ResultPackage{" +
                "m_strClientName='" + m_strClientName + '\'' +
                ", m_strServerName='" + m_strServerName + '\'' +
                ", m_lGrpID=" + m_lGrpID +
                ", m_nEventType='" + m_nEventType + '\'' +
                ", m_strPackType='" + m_strPackType + '\'' +
                ", m_strGameEventName='" + m_strGameEventName + '\'' +
                ", m_nSex=" + m_nSex +
                ", m_strSort='" + m_strSort + '\'' +
                ", m_strEvent='" + m_strEvent + '\'' +
                ", m_nLayer=" + m_nLayer +
                ", m_nGrp=" + m_nGrp +
                ", m_nProperty=" + m_nProperty +
                ", m_strAllEventName='" + m_strAllEventName + '\'' +
                ", m_nAllProp=" + m_nAllProp +
                ", m_nAllNum=" + m_nAllNum +
                ", m_strWindSpeed='" + m_strWindSpeed + '\'' +
                ", m_nField=" + m_nField +
                ", m_strBeginTime='" + m_strBeginTime + '\'' +
                ", m_nCheck=" + m_nCheck +
                ", m_nAffirmFlag=" + m_nAffirmFlag +
                ", m_nSporterNum=" + m_nSporterNum +
                ", m_strRecordRank=" + Arrays.toString(m_strRecordRank) +
                ", m_strRecordResult=" + Arrays.toString(m_strRecordResult) +
                ", m_nPlace=" + Arrays.toString(m_nPlace) +
                ", m_nTrackNO=" + Arrays.toString(m_nTrackNO) +
                ", m_strSporterID=" + Arrays.toString(m_strSporterID) +
                ", m_strSporterName=" + Arrays.toString(m_strSporterName) +
                ", m_strUnitName=" + Arrays.toString(m_strUnitName) +
                ", m_strResult=" + Arrays.toString(m_strResult) +
                ", m_strNote=" + Arrays.toString(m_strNote) +
                ", m_strSporterScoreCheck=" + Arrays.toString(m_strSporterScoreCheck) +
                ", m_strJudgeTime=" + Arrays.toString(m_strJudgeTime) +
                ", m_strExamSitePlace='" + m_strExamSitePlace + '\'' +
                ", m_nGroupType=" + m_nGroupType +
                ", m_nGender=" + Arrays.toString(m_nGender) +
                ", m_strUnitCode=" + Arrays.toString(m_strUnitCode) +
                ", m_strClassName=" + Arrays.toString(m_strClassName) +
                ", m_strStudentCategory=" + Arrays.toString(m_strStudentCategory) +
                ", m_strBestScore=" + Arrays.toString(m_strBestScore) +
                ", m_nExamStatus=" + Arrays.toString(m_nExamStatus) +
                '}';
    }
}
